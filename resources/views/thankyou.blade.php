...
<html lang="en">
  ...
  <body>
    ...
    <div class="thank-you-section" style="padding-top:150px;text-align:center;">
       <h1>Thank you for <br> Your Order!</h1>
       <p>Your loyalty means everything to us. Thank you for being a customer!</p>
       <div class="spacer"></div><br/>
       <div>
           <a href="{{ url('/') }}" class="btn btn-primary btn-sm">Shop again</a>
       </div>
   </div>
