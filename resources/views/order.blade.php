  ...
  <body>
    ...
    @foreach($order as $orders)
      ...
      <div class="product-item">
        <a href="{{ route('shop.show',$orders->slug) }}"><img src="../resources/assets/images/{{ $orders->slug }}.jpg" alt=""></a>
        <div class="down-content">
          <a href="{{ route('shop.show',$alsoLike->slug) }}"><h4>{{ $orders->name }}</h4></a>
          <h6>{{ $orders->presentPrice() }}</h6>
        </div>
      </div>
    </div>
    @endforeach
