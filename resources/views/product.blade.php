      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div>
              <img src="../resources/assets/images/{{ $product->slug }}.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
              <div class="col-sm-4 col-xs-6">
                <div>
                  <img src="../resources/assets/images/{{ $product->slug }}.jpg" alt="" class="img-fluid">
                </div>
                <br>
              </div>
              <div class="col-sm-4 col-xs-6">
          ...
          <div class="col-md-8 col-xs-12">
              ...
              <p class="lead">
                <strong class="text-primary">{{ $product->presentPrice() }}</strong>
              </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              <a href="{{ route('shop.show',$alsoLike->slug) }}"><img src="../resources/assets/images/{{ $alsoLike->slug }}.jpg" alt=""></a>
              <div class="down-content">
                <a href="{{ route('shop.show',$alsoLike->slug) }}"><h4>{{ $alsoLike->name }}</h4></a>
                <h6>{{ $alsoLike->presentPrice() }}</h6>
              </div>
            </div>
          </div>
          @endforeach
